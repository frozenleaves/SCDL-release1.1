...
def track_mask(mask, displace=40, gap_fill=5, render_phase=False, size_min=100, PCNA_intensity=None, BF_intensity=None):
    ...
    for i in range(mask.shape[0]):
        ...
        for k in range(props.shape[0]):
            ...
            print(mask_lbd.shape)
            print(PCNA_intensity.shape)
...
if __name__ == '__main__':
    pcna = '/home/zje/CellClassify/predict_data/dataset/mcy/copy_of_1_xy01.tif'
    bf = '/home/zje/CellClassify/predict_data/dataset/dic/copy_of_1_xy01.tif'
    output = '/home/zje/CellClassify/predict_data/dataset/copy_of_1_xy01_modify.json'
    ret = track_GT_json(fp_json=output, fp_pcna=pcna, fp_bf=bf,height=2048, width=2048)
    print(type(ret))
    print(type(ret[0]))
    print(len(ret))
    print(ret[1])
    ret[0].to_csv(r"/home/zje/CellClassify/predict_data/dataset/copy_of_1_xy01_track.csv")